...
#define NS_DECL_NSIJUMPLISTBUILDER \
  ...
  NS_IMETHOD InitListBuild(nsIMutableArray *removedItems, bool *_retval) override; \
  ...
  NS_IMETHOD CommitListBuild(bool *_retval) override; \
  NS_IMETHOD DeleteActiveList(bool *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIJUMPLISTBUILDER \
  NS_METHOD GetAvailable(int16_t *aAvailable); \
  NS_METHOD GetIsListCommitted(bool *aIsListCommitted); \
  NS_METHOD GetMaxListItems(int16_t *aMaxListItems); \
  NS_METHOD InitListBuild(nsIMutableArray *removedItems, bool *_retval); \
  NS_METHOD AddListToBuild(int16_t aCatType, nsIArray *items, const nsAString & catName, bool *_retval); \
  NS_METHOD AbortListBuild(void); \
  NS_METHOD CommitListBuild(bool *_retval); \
  NS_METHOD DeleteActiveList(bool *_retval); 
...
#define NS_FORWARD_NSIJUMPLISTBUILDER(_to) \
  ...
  NS_IMETHOD InitListBuild(nsIMutableArray *removedItems, bool *_retval) override { return _to InitListBuild(removedItems, _retval); } \
  ...
  NS_IMETHOD CommitListBuild(bool *_retval) override { return _to CommitListBuild(_retval); } \
...
#define NS_FORWARD_SAFE_NSIJUMPLISTBUILDER(_to) \
  ...
  NS_IMETHOD InitListBuild(nsIMutableArray *removedItems, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->InitListBuild(removedItems, _retval); } \
  ...
  NS_IMETHOD CommitListBuild(bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CommitListBuild(_retval); } \
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsJumpListBuilder, nsIJumpListBuilder)
