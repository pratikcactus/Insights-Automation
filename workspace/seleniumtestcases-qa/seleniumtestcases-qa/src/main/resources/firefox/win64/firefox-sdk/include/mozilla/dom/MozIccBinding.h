...
bool
ToJSValue(JSContext* aCx, IccCardState aArgument, JS::MutableHandle<JS::Value> aValue);
...
bool
ToJSValue(JSContext* aCx, IccLockType aArgument, JS::MutableHandle<JS::Value> aValue);
...
bool
ToJSValue(JSContext* aCx, IccContactType aArgument, JS::MutableHandle<JS::Value> aValue);
...
bool
ToJSValue(JSContext* aCx, IccMvnoType aArgument, JS::MutableHandle<JS::Value> aValue);
...
bool
ToJSValue(JSContext* aCx, IccService aArgument, JS::MutableHandle<JS::Value> aValue);
