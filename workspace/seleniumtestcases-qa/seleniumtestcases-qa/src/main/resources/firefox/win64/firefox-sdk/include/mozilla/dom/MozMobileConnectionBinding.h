...
bool
ToJSValue(JSContext* aCx, MobileNetworkSelectionMode aArgument, JS::MutableHandle<JS::Value> aValue);
...
bool
ToJSValue(JSContext* aCx, MobileRadioState aArgument, JS::MutableHandle<JS::Value> aValue);
...
bool
ToJSValue(JSContext* aCx, MobileNetworkType aArgument, JS::MutableHandle<JS::Value> aValue);
...
bool
ToJSValue(JSContext* aCx, MobilePreferredNetworkType aArgument, JS::MutableHandle<JS::Value> aValue);
...
bool
ToJSValue(JSContext* aCx, MobileRoamingMode aArgument, JS::MutableHandle<JS::Value> aValue);
