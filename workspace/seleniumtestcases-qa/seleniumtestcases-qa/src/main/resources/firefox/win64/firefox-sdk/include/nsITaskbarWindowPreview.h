...
#define NS_DECL_NSITASKBARWINDOWPREVIEW \
  NS_IMETHOD GetButton(uint32_t index, nsITaskbarPreviewButton * *_retval) override; \
  NS_IMETHOD GetEnableCustomDrawing(bool *aEnableCustomDrawing) override; \
  NS_IMETHOD SetEnableCustomDrawing(bool aEnableCustomDrawing) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSITASKBARWINDOWPREVIEW \
  NS_METHOD GetButton(uint32_t index, nsITaskbarPreviewButton * *_retval); \
  NS_METHOD GetEnableCustomDrawing(bool *aEnableCustomDrawing); \
  NS_METHOD SetEnableCustomDrawing(bool aEnableCustomDrawing); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSITASKBARWINDOWPREVIEW(_to) \
  NS_IMETHOD GetButton(uint32_t index, nsITaskbarPreviewButton * *_retval) override { return _to GetButton(index, _retval); } \
  NS_IMETHOD GetEnableCustomDrawing(bool *aEnableCustomDrawing) override { return _to GetEnableCustomDrawing(aEnableCustomDrawing); } \
  NS_IMETHOD SetEnableCustomDrawing(bool aEnableCustomDrawing) override { return _to SetEnableCustomDrawing(aEnableCustomDrawing); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSITASKBARWINDOWPREVIEW(_to) \
  NS_IMETHOD GetButton(uint32_t index, nsITaskbarPreviewButton * *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetButton(index, _retval); } \
  NS_IMETHOD GetEnableCustomDrawing(bool *aEnableCustomDrawing) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnableCustomDrawing(aEnableCustomDrawing); } \
  NS_IMETHOD SetEnableCustomDrawing(bool aEnableCustomDrawing) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetEnableCustomDrawing(aEnableCustomDrawing); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTaskbarWindowPreview, nsITaskbarWindowPreview)
