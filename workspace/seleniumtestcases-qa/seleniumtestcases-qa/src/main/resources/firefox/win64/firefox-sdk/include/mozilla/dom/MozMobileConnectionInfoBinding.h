...
bool
ToJSValue(JSContext* aCx, MobileConnectionState aArgument, JS::MutableHandle<JS::Value> aValue);
...
bool
ToJSValue(JSContext* aCx, MobileConnectionType aArgument, JS::MutableHandle<JS::Value> aValue);
