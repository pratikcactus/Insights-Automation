...
{
  Optional<RefPtr<LifecycleAttachedCallback>> mAttachedCallback;
  Optional<RefPtr<LifecycleAttributeChangedCallback>> mAttributeChangedCallback;
  Optional<RefPtr<LifecycleCreatedCallback>> mCreatedCallback;
  Optional<RefPtr<LifecycleDetachedCallback>> mDetachedCallback;
