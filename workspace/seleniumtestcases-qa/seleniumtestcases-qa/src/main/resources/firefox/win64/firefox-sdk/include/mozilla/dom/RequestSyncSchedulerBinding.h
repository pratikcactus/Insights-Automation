...
{
public:
  explicit inline RequestSyncSchedulerJSImpl(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
...
private:
  RefPtr<RequestSyncSchedulerJSImpl> mImpl;
