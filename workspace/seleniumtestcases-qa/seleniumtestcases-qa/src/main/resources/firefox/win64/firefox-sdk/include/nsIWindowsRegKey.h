...
#define NS_DECL_NSIWINDOWSREGKEY \
  NS_IMETHOD GetKey(HKEY *aKey) override; \
  NS_IMETHOD SetKey(HKEY aKey) override; \
  ...
  NS_IMETHOD StartWatching(bool recurse) override; \
  NS_IMETHOD StopWatching(void) override; \
  NS_IMETHOD IsWatching(bool *_retval) override; \
  NS_IMETHOD HasChanged(bool *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIWINDOWSREGKEY \
  NS_METHOD GetKey(HKEY *aKey); \
  NS_METHOD SetKey(HKEY aKey); \
  NS_METHOD Close(void); \
  NS_METHOD Open(uint32_t rootKey, const nsAString & relPath, uint32_t mode); \
  NS_METHOD Create(uint32_t rootKey, const nsAString & relPath, uint32_t mode); \
  NS_METHOD OpenChild(const nsAString & relPath, uint32_t mode, nsIWindowsRegKey * *_retval); \
  NS_METHOD CreateChild(const nsAString & relPath, uint32_t mode, nsIWindowsRegKey * *_retval); \
  NS_METHOD GetChildCount(uint32_t *aChildCount); \
  NS_METHOD GetChildName(uint32_t index, nsAString & _retval); \
  NS_METHOD HasChild(const nsAString & name, bool *_retval); \
  NS_METHOD GetValueCount(uint32_t *aValueCount); \
  NS_METHOD GetValueName(uint32_t index, nsAString & _retval); \
  NS_METHOD HasValue(const nsAString & name, bool *_retval); \
  NS_METHOD RemoveChild(const nsAString & relPath); \
  NS_METHOD RemoveValue(const nsAString & name); \
  NS_METHOD GetValueType(const nsAString & name, uint32_t *_retval); \
  NS_METHOD ReadStringValue(const nsAString & name, nsAString & _retval); \
  NS_METHOD ReadIntValue(const nsAString & name, uint32_t *_retval); \
  NS_METHOD ReadInt64Value(const nsAString & name, uint64_t *_retval); \
  NS_METHOD ReadBinaryValue(const nsAString & name, nsACString & _retval); \
  NS_METHOD WriteStringValue(const nsAString & name, const nsAString & data); \
  NS_METHOD WriteIntValue(const nsAString & name, uint32_t data); \
  NS_METHOD WriteInt64Value(const nsAString & name, uint64_t data); \
  NS_METHOD WriteBinaryValue(const nsAString & name, const nsACString & data); \
  NS_METHOD StartWatching(bool recurse); \
  NS_METHOD StopWatching(void); \
  NS_METHOD IsWatching(bool *_retval); \
  NS_METHOD HasChanged(bool *_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWINDOWSREGKEY(_to) \
  NS_IMETHOD GetKey(HKEY *aKey) override { return _to GetKey(aKey); } \
  NS_IMETHOD SetKey(HKEY aKey) override { return _to SetKey(aKey); } \
  ...
  NS_IMETHOD StartWatching(bool recurse) override { return _to StartWatching(recurse); } \
  NS_IMETHOD StopWatching(void) override { return _to StopWatching(); } \
  NS_IMETHOD IsWatching(bool *_retval) override { return _to IsWatching(_retval); } \
  NS_IMETHOD HasChanged(bool *_retval) override { return _to HasChanged(_retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWINDOWSREGKEY(_to) \
  NS_IMETHOD GetKey(HKEY *aKey) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetKey(aKey); } \
  NS_IMETHOD SetKey(HKEY aKey) override { return !_to ? NS_ERROR_NULL_POINTER : _to->SetKey(aKey); } \
  ...
  NS_IMETHOD StartWatching(bool recurse) override { return !_to ? NS_ERROR_NULL_POINTER : _to->StartWatching(recurse); } \
  NS_IMETHOD StopWatching(void) override { return !_to ? NS_ERROR_NULL_POINTER : _to->StopWatching(); } \
  NS_IMETHOD IsWatching(bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->IsWatching(_retval); } \
  NS_IMETHOD HasChanged(bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->HasChanged(_retval); } 
