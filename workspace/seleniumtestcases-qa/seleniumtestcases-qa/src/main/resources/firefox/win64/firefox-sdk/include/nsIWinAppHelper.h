...
#define NS_DECL_NSIWINAPPHELPER \
  NS_IMETHOD GetUserCanElevate(bool *aUserCanElevate) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIWINAPPHELPER \
  NS_METHOD GetUserCanElevate(bool *aUserCanElevate); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWINAPPHELPER(_to) \
  NS_IMETHOD GetUserCanElevate(bool *aUserCanElevate) override { return _to GetUserCanElevate(aUserCanElevate); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWINAPPHELPER(_to) \
  NS_IMETHOD GetUserCanElevate(bool *aUserCanElevate) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUserCanElevate(aUserCanElevate); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsWinAppHelper, nsIWinAppHelper)
