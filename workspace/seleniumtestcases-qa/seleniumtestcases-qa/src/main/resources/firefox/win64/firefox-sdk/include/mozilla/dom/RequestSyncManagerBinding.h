...
bool
ToJSValue(JSContext* aCx, RequestSyncTaskPolicyState aArgument, JS::MutableHandle<JS::Value> aValue);
...
{
public:
  explicit inline RequestSyncAppJSImpl(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
...
private:
  RefPtr<RequestSyncAppJSImpl> mImpl;
...
{
public:
  explicit inline RequestSyncManagerJSImpl(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
    : CallbackInterface(aCx, aCallback, aIncumbentGlobal)
  {
  }
...
private:
  RefPtr<RequestSyncManagerJSImpl> mImpl;
  nsCOMPtr<nsISupports> mParent;
...
{
public:
  explicit inline RequestSyncTaskJSImpl(JSContext* aCx, JS::Handle<JSObject*> aCallback, nsIGlobalObject* aIncumbentGlobal)
    : CallbackInterface(aCx, aCallback, aIncumbentGlobal)
  {
  }
...
private:
  RefPtr<RequestSyncTaskJSImpl> mImpl;
  nsCOMPtr<nsISupports> mParent;
