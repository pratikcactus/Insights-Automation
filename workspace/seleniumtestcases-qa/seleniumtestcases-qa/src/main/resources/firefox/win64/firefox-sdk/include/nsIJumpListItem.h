...
#define NS_DECL_NON_VIRTUAL_NSIJUMPLISTITEM \
  NS_METHOD GetType(int16_t *aType); \
  NS_METHOD Equals(nsIJumpListItem *item, bool *_retval); 
...
#define NS_FORWARD_NSIJUMPLISTITEM(_to) \
  ...
  NS_IMETHOD Equals(nsIJumpListItem *item, bool *_retval) override { return _to Equals(item, _retval); } 
...
#define NS_FORWARD_SAFE_NSIJUMPLISTITEM(_to) \
  ...
  NS_IMETHOD Equals(nsIJumpListItem *item, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->Equals(item, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsJumpListItem, nsIJumpListItem)
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIJUMPLISTSEPARATOR \
  /* no methods! */
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsJumpListSeparator, nsIJumpListSeparator)
...
#define NS_DECL_NSIJUMPLISTLINK \
  ...
  NS_IMETHOD GetUriHash(nsACString & aUriHash) override; \
  NS_IMETHOD CompareHash(nsIURI *uri, bool *_retval) override; 

/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIJUMPLISTLINK \
  NS_METHOD GetUri(nsIURI * *aUri); \
  NS_METHOD SetUri(nsIURI *aUri); \
  NS_METHOD GetUriTitle(nsAString & aUriTitle); \
  NS_METHOD SetUriTitle(const nsAString & aUriTitle); \
  NS_METHOD GetUriHash(nsACString & aUriHash); \
  NS_METHOD CompareHash(nsIURI *uri, bool *_retval); 
...
#define NS_FORWARD_NSIJUMPLISTLINK(_to) \
  ...
  NS_IMETHOD GetUriHash(nsACString & aUriHash) override { return _to GetUriHash(aUriHash); } \
  NS_IMETHOD CompareHash(nsIURI *uri, bool *_retval) override { return _to CompareHash(uri, _retval); } 
...
#define NS_FORWARD_SAFE_NSIJUMPLISTLINK(_to) \
  ...
  NS_IMETHOD GetUriHash(nsACString & aUriHash) override { return !_to ? NS_ERROR_NULL_POINTER : _to->GetUriHash(aUriHash); } \
  NS_IMETHOD CompareHash(nsIURI *uri, bool *_retval) override { return !_to ? NS_ERROR_NULL_POINTER : _to->CompareHash(uri, _retval); } 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsJumpListLink, nsIJumpListLink)
...
/* Use this macro when declaring the members of this interface when the
   class doesn't implement the interface. This is useful for forwarding. */
#define NS_DECL_NON_VIRTUAL_NSIJUMPLISTSHORTCUT \
  NS_METHOD GetApp(nsILocalHandlerApp * *aApp); \
  NS_METHOD SetApp(nsILocalHandlerApp *aApp); \
  NS_METHOD GetIconIndex(int32_t *aIconIndex); \
  NS_METHOD SetIconIndex(int32_t aIconIndex); \
  NS_METHOD GetFaviconPageUri(nsIURI * *aFaviconPageUri); \
  NS_METHOD SetFaviconPageUri(nsIURI *aFaviconPageUri); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsJumpListShortcut, nsIJumpListShortcut)
