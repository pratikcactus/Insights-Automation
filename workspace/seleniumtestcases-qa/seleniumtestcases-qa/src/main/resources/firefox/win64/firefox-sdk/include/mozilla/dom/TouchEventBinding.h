...
{
  Sequence<OwningNonNull<mozilla::dom::Touch>> mChangedTouches;
  Sequence<OwningNonNull<mozilla::dom::Touch>> mTargetTouches;
  Sequence<OwningNonNull<mozilla::dom::Touch>> mTouches;
