...
#define NS_DECL_NON_VIRTUAL_NSITASKBAROVERLAYICONCONTROLLER \
  NS_METHOD SetOverlayIcon(imgIContainer *statusIcon, const nsAString & statusDescription); 
...
/* Implementation file */
NS_IMPL_ISUPPORTS(nsTaskbarOverlayIconController, nsITaskbarOverlayIconController)
